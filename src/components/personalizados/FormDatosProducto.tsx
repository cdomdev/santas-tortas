...
const FormDatosProducto = () => {
    ...
    const handleSubmit = (values: Personalizado, { setSubmitting }: any) => {
        ...
        setSubmitting(false);
        if(values){
            window.sessionStorage.setItem('data-product-custom', JSON.stringify(values));
            window.location.href = "/personalizados/form-submit"
        }
    };
    return (
        <Formik
            ...
            validate={(values: Personalizado) => {
                ...
                if (!values.tematica) errors.tematica = "¡Este campo no puede quedar vacío!";
                if (!values.relleno) errors.relleno = "¡Este campo no puede quedar vacío!";
                ...
                if (!values.porciones) errors.porciones = "¡Este campo no puede quedar vacío!";
                if (!values.mensaje) errors.mensaje = "¡Este campo no puede quedar vacío!";
                return errors;
            }}
                ...
                <Form className="max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            <ErrorMessage name="tematica" component="span" className="text-red-600 text-xs" />
                        </div>
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            <ErrorMessage name="relleno" component="span" className="text-red-600 text-xs" />
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-5">
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            <ErrorMessage name="sabor" component="span" className="text-red-600 text-xs" />
                        </div>


                        <div className="relative z-0 w-full mb-5 group flex flex-col">
                            <label htmlFor="fecha" className="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">¿Para cuándo lo necesitas?</label>
                            <Field
                                type="date"
                                name="fecha"
                                id="fecha"
                                ...
                                onChange={(event: React.ChangeEvent<HTMLInputElement>) => formik.setFieldValue("fecha", event.target.value)}
                            />
                            <ErrorMessage name="fecha" component="span" className="text-red-600 text-xs" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-5">
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            <ErrorMessage name="porciones" component="span" className="text-red-600 text-xs" />
                        </div>



                        <div className="relative z-0 w-full mb-5 group">
                            <label htmlFor="foto" className="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">¿Algún diseño en mente?</label>
                            ...
                            <label
                                htmlFor="foto"
                                className="cursor-pointer bg-gray-200 hover:bg-gray-300 text-gray-700 py-2.5 px-4 rounded-md w-full text-center inline-block text-sm flex items-center justify-center"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" width="24" height="24" className="w-5 h-5 mr-1" strokeWidth="2">
                            ...
                            <div className="mt-1 text-sm text-gray-500 text-center">
                                {formik.values.foto instanceof File ? formik.values.foto.name : "No hay archivo seleccionado"}
                            </div>
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        ...
                        <ErrorMessage name="mensaje" component="span" className="text-red-600 text-xs" />
                    </div>
